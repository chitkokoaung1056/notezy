...
const InputBox = (props) => {
  ...
  const secure=secureTextEntry?true:false
  const left=leftIcon?true:false
  const right=rightIcon?true:false
  ...
  useEffect(() => {
    ...
    secure?setPasswordEnabled(true):setPasswordEnabled(false)
  }, [])
